...
class BookNow{
    ...
    async bookNow(){
        ...
        await lbBookNowLoadDetailsPickUpCard.waitForExist({ timeout: 5000 })
        await lbBookNowLoadDetailsDeliveryCard.waitForDisplayed({ timeout: 5000 })
        await lbBookNowLoadDetailsDeliveryCard.waitForExist({ timeout: 5000 })
        await lbBookNowLoadDetailsText.waitForDisplayed({ timeout: 5000 })
        await lbBookNowLoadDetailsText.waitForExist({ timeout: 5000 })
        await lbBookNowLoadDetailsStatus.waitForDisplayed({ timeout: 5000 })
        await lbBookNowLoadDetailsStatus.waitForExist({ timeout: 5000 })
        ...
        await bookNowTitle.waitForExist({ timeout: 5000 })
        await bookNowSubTitle.waitForDisplayed({ timeout: 5000 })
        await bookNowSubTitle.waitForExist({ timeout: 5000 })
        await bookNowAreYouSure.waitForDisplayed({ timeout: 5000 })
        await bookNowAreYouSure.waitForExist({ timeout: 5000 })
        await bookNowPickUpAddress.waitForDisplayed({ timeout: 5000 })
        await bookNowPickUpAddress.waitForExist({ timeout: 5000 })
        await bookNowDeliveryAddress.waitForDisplayed({ timeout: 5000 })
        await bookNowDeliveryAddress.waitForExist({ timeout: 5000 })
        await bookNowMode.waitForDisplayed({ timeout: 5000 })
        await bookNowMode.waitForExist({ timeout: 5000 })
        await bookNowEquipment.waitForDisplayed({ timeout: 5000 })
        await bookNowEquipment.waitForExist({ timeout: 5000 })
        await bookNowTotalStops.waitForDisplayed({ timeout: 5000 })
        await bookNowTotalStops.waitForExist({ timeout: 5000 })
        await bookNowTotalMiles.waitForDisplayed({ timeout: 5000 })
        await bookNowTotalMiles.waitForExist({ timeout: 5000 })
        await bookNowTotalWeight.waitForDisplayed({ timeout: 5000 })
        await bookNowTotalWeight.waitForExist({ timeout: 5000 })
        await bookNowBookBtn.waitForDisplayed({ timeout: 5000 })
        await bookNowBookBtn.waitForExist({ timeout: 5000 })
        await bookNowCancelButton.waitForDisplayed({ timeout: 5000 })
        await bookNowCancelButton.waitForExist({ timeout: 5000 })
